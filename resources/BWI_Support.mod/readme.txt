BWI Medical Tent Box Instructions:
...
\Blender\medicalTentBox.blend: Project file for blender.
...
BWI_medical_tentBox\config.cpp: Addon definitions
BWI_medical_tentBox\model\medicalTentBox.p3d: 3D Arma model of the boxes
BWI_medical_tentBox\pictures\medicalTentBox_logo.paa: Icon of the box in the arsenal
BWI_medical_tentBox\textures\medicalTentBox_co.paa: Color texture of the box. Created from the \Gimp\tentBox.xcf.
...
Copy the folder "BWI_medical_tentBox" to the P drive root.
Open Addon Builder:
Addon source directory: P:\BWI_medical_tentBox
...
Export as Arma p3d to P:\BWI_medical_tentBox\model\medicalTentBox.p3d.
...
Go into Arma 3 Tools and open TexView2. Open the exported PNG and click Save As. Select the texture as a .paa at: BWI_medical_tentBox\textures\medicalTentBox_co.paa
...
5. Changing the icon
To change the Arsenal icon of the medical tent box. Open the GIMP project at \Gimp\tentBox_logo.xcf. Make your changes and export the image to a PNG at a temporary location.
Go into Arma 3 Tools and open TexView2. Open the exported PNG and click Save As. Select the texture as a .paa at: BWI_medical_tentBox\pictures\medicalTentBox_logo.paa.
