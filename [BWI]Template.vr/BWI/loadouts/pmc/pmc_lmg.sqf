...
[_unit, "AR", "PM", 2014] call BWI_fnc_AddGear;
[_unit, "AR"] call BWI_fnc_AddMedical;

for "_i" from 1 to 12 do {_unit addItemToBackpack "hlc_40Rnd_556x45_B_AUG";};
for "_i" from 1 to 6 do {_unit addItemToVest "hlc_40Rnd_556x45_B_AUG";};