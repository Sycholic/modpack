...
[_unit, "RIF", "IN", 1984] call BWI_fnc_AddGear;
[_unit, "RIF"] call BWI_fnc_AddMedical;

for "_i" from 1 to 4 do {_unit addItemToVest "RH_20Rnd_762x51_AR10";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "RH_20Rnd_762x51_AR10";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "RH_20Rnd_762x51_AR10";};